...
LLM_VERSION="/mnt/shared-storage-user/jiaziheng/LMMS/llava-ov-chat-qwen2-VQA++_foundation"
...
#其余参数尽量不要做修改
deepspeed --include localhost:0,1,2,3,4,5,6,7 --master_port 25808 ./llava/train/train.py \
    --deepspeed scripts/zero3.json \
    --model_name_or_path ${CKPT_PATH} \
    --version ${PROMPT_VERSION} \
    --data_path /data/tos/jiaziheng/quality_foundation_model/train_foundation/llava/merged_foundation_training2.json\
    --lora_enable False \
    ...
    --bf16 True \
    --output_dir /mnt/shared-storage-user/jiaziheng/LMMS/llava-ov-chat-qwen2-assessor/ \
    --num_train_epochs 1 \
