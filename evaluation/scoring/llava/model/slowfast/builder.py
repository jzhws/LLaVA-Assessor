...
class slowfast(torch.nn.Module):
    def __init__(self):
        ...
        slowfast_pretrained_features = torch.load('/data/tos/jiaziheng/VQA++/Visual-Question-Answering-for-Video-Quality-Assessment/VQA_main/slowfast.pth',weights_only=False)
